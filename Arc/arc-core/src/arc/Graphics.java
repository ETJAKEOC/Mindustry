...
public abstract class Graphics implements Disposable {
     ...
     *
     * @param r                number of bits per color channel
     * @param depth            number of bits for depth and stencil buffer
     ...
     */
    public record BufferFormat(int r, int g, int b, int a, int depth, int stencil, int samples,
