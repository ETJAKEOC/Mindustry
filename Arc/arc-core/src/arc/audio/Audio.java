...
import static arc.audio.Soloud.activeVoiceCount;
import static arc.audio.Soloud.backendBufferSize;
import static arc.audio.Soloud.backendChannels;
import static arc.audio.Soloud.backendSamplerate;
import static arc.audio.Soloud.backendString;
import static arc.audio.Soloud.deinit;
import static arc.audio.Soloud.filterFade;
import static arc.audio.Soloud.filterSet;
import static arc.audio.Soloud.idLooping;
import static arc.audio.Soloud.idPan;
import static arc.audio.Soloud.idPause;
import static arc.audio.Soloud.idPitch;
import static arc.audio.Soloud.idProtected;
import static arc.audio.Soloud.idStop;
import static arc.audio.Soloud.idValid;
import static arc.audio.Soloud.idVolume;
import static arc.audio.Soloud.init;
import static arc.audio.Soloud.pauseAll;
import static arc.audio.Soloud.setGlobalFilter;
import static arc.audio.Soloud.sourceCount;
import static arc.audio.Soloud.sourcePlay;
import static arc.audio.Soloud.sourceStop;
import static arc.audio.Soloud.stopAll;
import static arc.audio.Soloud.version;
