...
import static arc.audio.Soloud.bassBoostSet;
import static arc.audio.Soloud.biquadSet;
import static arc.audio.Soloud.echoSet;
import static arc.audio.Soloud.filterBassBoost;
import static arc.audio.Soloud.filterBiquad;
import static arc.audio.Soloud.filterEcho;
import static arc.audio.Soloud.filterFlanger;
import static arc.audio.Soloud.filterFreeverb;
import static arc.audio.Soloud.filterLofi;
import static arc.audio.Soloud.filterRobotize;
import static arc.audio.Soloud.filterWaveShaper;
import static arc.audio.Soloud.flangerSet;
import static arc.audio.Soloud.freeverbSet;
import static arc.audio.Soloud.lofiSet;
import static arc.audio.Soloud.robotizeSet;
import static arc.audio.Soloud.waveShaperSet;
