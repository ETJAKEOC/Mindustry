...
public class Gl {
	...
	private static final IntBuffer ibuf = Buffers.newIntBuffer(1);
	private static final FloatBuffer fbuf = Buffers.newFloatBuffer(1);
	 ...
	 */
	private static final Bits enabled = new Bits();
