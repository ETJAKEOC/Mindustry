...
public class VertexAttribute {
	...
	public static final VertexAttribute packedPosition = new VertexAttribute(2, GL20.GL_UNSIGNED_SHORT, true, Shader.positionAttribute);
	public static final VertexAttribute texCoords = new VertexAttribute(2, Shader.texcoordAttribute + "0");
	public static final VertexAttribute packedTexCoords = new VertexAttribute(2, GL20.GL_UNSIGNED_SHORT, true, Shader.texcoordAttribute + "0");
	public static final VertexAttribute normal = new VertexAttribute(3, Shader.normalAttribute);
	public static final VertexAttribute packedNormal = new VertexAttribute(4, GL30.GL_INT_2_10_10_10_REV, true, Shader.normalAttribute);
	public static final VertexAttribute color = new VertexAttribute(4, GL20.GL_UNSIGNED_BYTE, true, Shader.colorAttribute);
	public static final VertexAttribute mixColor = new VertexAttribute(4, GL20.GL_UNSIGNED_BYTE, true, Shader.mixColorAttribute);
