...
public class TextureAtlas implements Disposable {
	...
	public AtlasRegion find(String name) {
		AtlasRegion r = regionmap.get(name, (AtlasRegion) null);
		if (r == null) {
			if (name.startsWith("ve-")) r = regionmap.get(name.substring(3), (AtlasRegion) null);
			else if (name.startsWith("nh-")) r = regionmap.get(name.substring(3), (AtlasRegion) null);
			else if (name.startsWith("eu-")) r = regionmap.get(name.substring(3), (AtlasRegion) null);
			else if (name.startsWith("new-horizon-")) r = regionmap.get(name.substring(12), (AtlasRegion) null);
			else if (name.startsWith("extra-utilities-")) r = regionmap.get(name.substring(16), (AtlasRegion) null);
			else if (name.startsWith("vanilla-expansion-")) r = regionmap.get(name.substring(18), (AtlasRegion) null);

			if (r == null && !name.startsWith("ve-") && !name.startsWith("nh-") && !name.startsWith("eu-")) {
				r = regionmap.get("ve-" + name, (AtlasRegion) null);
				if (r == null) r = regionmap.get("nh-" + name, (AtlasRegion) null);
				if (r == null) r = regionmap.get("eu-" + name, (AtlasRegion) null);
				if (r == null) r = regionmap.get("new-horizon-" + name, (AtlasRegion) null);
			}
	...
	public TextureRegion find(String name, TextureRegion def) {
		TextureRegion region = find(name);
		return region == null || region == error ? def : region;
	}

	public boolean has(String s) {
		return regionmap.containsKey(s) ||
			(s.startsWith("ve-") && regionmap.containsKey(s.substring(3))) ||
			(s.startsWith("nh-") && regionmap.containsKey(s.substring(3))) ||
			(s.startsWith("eu-") && regionmap.containsKey(s.substring(3))) ||
			regionmap.containsKey("ve-" + s) ||
			regionmap.containsKey("nh-" + s) ||
			regionmap.containsKey("eu-" + s);
	}
