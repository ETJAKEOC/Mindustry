...
public class Extrapolator {
	private final float[] snapPos;
	private final float[] snapVel;
	private final float[] aimPos;
	private final float[] lastPacketPos;
	private final float[] tmpArr;
	private final float[] tmpArr2;
