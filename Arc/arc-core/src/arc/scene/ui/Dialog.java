...
public class Dialog extends Table {
	...
	public Element hit(float x, float y, boolean touchable) {
		...
		if (hit == null && isModal && (!touchable || this.touchable == Touchable.enabled))
			return this;
		return hit;
	}
	...
	public void hide(Action action) {
		...
		if (stage != null) {
			removeListener(focusListener);
			if (previousKeyboardFocus != null && (previousKeyboardFocus.getScene() == null || !previousKeyboardFocus.visible))
				previousKeyboardFocus = null;
			Element actor = stage.getKeyboardFocus();
			if (actor == null || actor.isDescendantOf(this))
				stage.setKeyboardFocus(previousKeyboardFocus);

			if (previousScrollFocus != null && (previousScrollFocus.getScene() == null || !previousScrollFocus.visible))
				previousScrollFocus = null;
			actor = stage.getScrollFocus();
			if (actor == null || actor.isDescendantOf(this))
