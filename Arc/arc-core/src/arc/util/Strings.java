...
public class Strings {
	...
	private static final Pattern unsafeFilenamePattern = Pattern.compile("[\0/\"'<>|:*!?\\\\]");
	private static final Pattern reservedFilenamePattern = Pattern.compile("(CON|AUX|PRN|NUL|(COM[0-9])|(LPT[0-9]))((\\..*$)|$)", Pattern.CASE_INSENSITIVE);
	...
	public static boolean containsIgnoreCase(String src, String what) {
		...
		final int limit = src.length() - length;
