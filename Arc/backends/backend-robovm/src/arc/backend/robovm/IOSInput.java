...
import org.robovm.apple.uikit.UIAdaptivePresentationControllerDelegateAdapter;
...
import arc.backend.robovm.custom.UIAccelerometer;
...
public class IOSInput extends Input {
	...
	private record NSObjectWrapper<T extends NSObject>(T instance) {
