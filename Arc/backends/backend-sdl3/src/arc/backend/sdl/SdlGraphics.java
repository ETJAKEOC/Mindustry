...
public class SdlGraphics extends Graphics {
	...
	private int mapCursor(SystemCursor cursor) {
		switch (cursor) {
			...
			case ibeam:
				return SDLMouse.SDL_SYSTEM_CURSOR_TEXT;
			case crosshair:
				return SDLMouse.SDL_SYSTEM_CURSOR_CROSSHAIR;
			case hand:
				return SDLMouse.SDL_SYSTEM_CURSOR_POINTER;
			case horizontalResize:
				return SDLMouse.SDL_SYSTEM_CURSOR_EW_RESIZE;
			case verticalResize:
				return SDLMouse.SDL_SYSTEM_CURSOR_NS_RESIZE;
		}
