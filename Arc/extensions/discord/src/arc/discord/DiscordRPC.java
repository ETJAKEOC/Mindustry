...
public final class DiscordRPC {
	...
	record Packet(PacketOp op, Jval data) {
	...
	public record User(String name, String discriminator, long id, @Nullable String avatar) {
	...
	public static class RichPresence {
		...
		Jval buttons() {
			...
			if (label1 != null && url1 != null)
				buttons.add(Jval.newObject().put("label", label1).put("url", url1));
			if (label2 != null && url2 != null)
				buttons.add(Jval.newObject().put("label", label2).put("url", url2));
			return buttons;
		}
	}
