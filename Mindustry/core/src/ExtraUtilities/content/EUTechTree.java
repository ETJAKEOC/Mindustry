    ...
    public static void load() {
        ...
        TDPlanet.TD.techTree = TechTree.nodeRoot("TD", TDSectorPresets.pd, () -> addToNode(TDSectorPresets.pd, () -> {
            node(TDSectorPresets.TD1, () -> {
                ...
                node(TDSectorPresets.guiYTD1, () -> node(TDSectorPresets.BossTD, Seq.with(new Objectives.Objective[]{new Objectives.SectorComplete(TDSectorPresets.TD1)}), () -> node(EUUnitTypes.regency, ItemStack.with(EUItems.lightninAlloy, 15000), () -> node(EUBlocks.randomer, Seq.with(new Objectives.Objective[]{new Objectives.SectorComplete(TDSectorPresets.BossTD)}), () -> {
                }))));
