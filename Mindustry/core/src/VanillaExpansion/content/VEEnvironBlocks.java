...
public class VEEnvironBlocks {
    public static void load(){
        ...
        //矿
        new OreBlock("ore-salt") {{ itemDrop = Vars.content.item("ve-salt") != null ? Vars.content.item("ve-salt") : Items.sand; }};
        new OreBlock("ore-aluminium") {{ itemDrop = Vars.content.item("ve-aluminium") != null ? Vars.content.item("ve-aluminium") : Items.sand; }};
        new OreBlock("ore-silver") {{ itemDrop = Vars.content.item("ve-silver") != null ? Vars.content.item("ve-silver") : Items.sand; }};
        new OreBlock("ore-silver-pure") {{ itemDrop = Vars.content.item("ve-silver-pure") != null ? Vars.content.item("ve-silver-pure") : Items.sand; }};
        new OreBlock("ore-catalyzon") {{ itemDrop = Vars.content.item("ve-catalyzon") != null ? Vars.content.item("ve-catalyzon") : Items.sand; }};
        new OreBlock("ore-pyratite") {{ itemDrop = Items.pyratite; }};
        new OreBlock("ore-cobalt") {{ itemDrop = Vars.content.item("ve-cobalt") != null ? Vars.content.item("ve-cobalt") : Items.sand; }};
        new OreBlock("ore-ferrum") {{ itemDrop = Vars.content.item("ve-ferrum") != null ? Vars.content.item("ve-ferrum") : Items.sand; }};
        new OreBlock("ore-tantalum") {{ itemDrop = Vars.content.item("ve-tantalum") != null ? Vars.content.item("ve-tantalum") : Items.sand; }};
        new OreBlock("ore-thorium-maress") {{ itemDrop = Items.thorium; }};
        new OreBlock("ore-chromium") {{ itemDrop = Vars.content.item("ve-chromium") != null ? Vars.content.item("ve-chromium") : Items.sand; }};
        new OreBlock("ore-chromium-maress") {{ itemDrop = Vars.content.item("ve-chromium") != null ? Vars.content.item("ve-chromium") : Items.sand; }};
        new OreBlock("ore-wall-aluminium") {{ itemDrop = Vars.content.item("ve-aluminium") != null ? Vars.content.item("ve-aluminium") : Items.sand; }};
        new OreBlock("ore-wall-quartz") {{ itemDrop = Vars.content.item("ve-quartz") != null ? Vars.content.item("ve-quartz") : Items.sand; }};
