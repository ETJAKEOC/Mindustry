...
public class ProximaPlanetGenerator extends RegionControlledPlanetGenerator {
	...
	private Color getBiomeColor(int biomeIndex) {
		switch (biomeIndex) {
			...
			case 2:
				return Color.valueOf("A0BEA0");
			case 3:
				return Color.valueOf("A5B685");
			case 4:
				return Color.valueOf("9ACD32");
			case 5:
				return Color.valueOf("32CD32");
			case 6:
				return Color.valueOf("FFD700");
			case 7:
				return Color.valueOf("F4A460");
			case 8:
				return Color.valueOf("CD5C5C");
			default:
				return Color.valueOf("9ACD32");
		}
	}
