	...
	public class ShockwaveCoreBuild extends CoreBuild implements LaunchAnimator {
		...
		public void draw() {
			...
			if (thrusterTime > 0) {
				...
				if (enabled && !state.isEditor() && ui.hudfrag.shown) {
					drawChargeBar();
