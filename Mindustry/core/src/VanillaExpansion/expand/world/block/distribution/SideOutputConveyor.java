...
public class SideOutputConveyor extends Conveyor {
	...
	public void handlePlacementLine(Seq<BuildPlan> plans) {
		...
		if (bridgeReplacement instanceof DuctBridge bridge)
			Placement.calculateBridges(plans, bridge, hasJuntionReplacement, b -> b instanceof Duct || avoidBlock.get(b));
		if (bridgeReplacement instanceof ItemBridge bridge)
			Placement.calculateBridges(plans, bridge, hasJuntionReplacement, avoidBlock);
	}
