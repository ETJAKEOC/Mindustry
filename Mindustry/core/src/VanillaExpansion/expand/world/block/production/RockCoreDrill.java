...
public class RockCoreDrill extends Drill {
    ...
    public void load(){
        ...
        if(!rotatorRegion.found()){
            rotatorRegion = Core.atlas.find(name.replace("ve-", "") + "-rotator", Core.atlas.find("drill-rotator", Core.atlas.find("clear")));
        }

        topRegion = Core.atlas.find(baseName + "-top");
        if(!topRegion.found()){
            topRegion = Core.atlas.find(name.replace("ve-", "") + "-top", Core.atlas.find("drill-top", Core.atlas.find("clear")));
        }

        itemRegionDisplay = Core.atlas.find(baseName + "-item");
        if(!itemRegionDisplay.found()){
            itemRegionDisplay = Core.atlas.find(name.replace("ve-", "") + "-item", Core.atlas.find("drill-item", Core.atlas.find("clear")));
        }
