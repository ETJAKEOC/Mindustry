...
import arc.audio.Filters.BiquadFilter;
...
public class SoundControl {
	...
	protected Seq<Music> getAmbientMusic() {
		if (state.rules.ambientMusic != null)
	...
	protected void playOnce(Music music) {
		if (current != null || music == null || !shouldPlay())
			return; //do not interrupt already-playing tracks
