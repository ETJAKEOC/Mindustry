...
import static mindustry.Vars.clearSectors;
...
public class Control implements ApplicationListener, Loadable {
	...
	private final Seq<Building> toBePlaced = new Seq<>(false);
	private final Seq<Object[]> toBePlacedConfigs = new Seq<>();
	...
	public void update() {
		...
		if (!scene.hasKeyboard()) {
			if (Core.input.keyTap(Binding.performanceMetrics))
				Core.settings.toggle("showperformance");
		}
