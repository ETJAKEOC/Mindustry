...
import static mindustry.Vars.maxGlErrors;
...
public class Renderer implements ApplicationListener {
	...
	private boolean launching;	public float
	...
	/**
	 * @param env      Environment bitmask; must match env exactly when and-ed.
	 * @param renderer Rendering callback.
	 */
	public record EnvRenderer(int env, Runnable renderer) {
	}
