...
import mindustry.editor.data.MapAssetsDialog;
...
public class MapInfoDialog extends BaseDialog {
	...
	private final MapProcessorsDialog processors = new MapProcessorsDialog();
	private final MapAssetsDialog patches = new MapAssetsDialog();
