...
class GroupDefs<G> {
	@GroupDef(value = Entityc.class, exclude = {Unitc.class, PowerGraphUpdaterc.class, Bulletc.class, EffectStatec.class, Playerc.class}, update = true)
	G all;
	@GroupDef(value = EffectStatec.class)
	G effect;
	...
	G unit;
	@GroupDef(value = Buildingc.class, update = true)
	G build;
