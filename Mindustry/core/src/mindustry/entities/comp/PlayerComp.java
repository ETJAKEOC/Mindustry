...
import mindustry.annotations.Annotations.NoSync;
import mindustry.annotations.Annotations.ReadOnly;
...
abstract class PlayerComp implements UnitController, Entityc, Syncc, Timerc, Drawc {
	...
	void drawPing() {
		if (pingTime <= 0f || !renderer.showPings || name == null || (!state.rules.showOtherTeamPings && team != Vars.player.team()))
			return;
