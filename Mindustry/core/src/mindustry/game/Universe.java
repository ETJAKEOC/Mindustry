...
import static mindustry.Vars.baseInvasionChance;
import static mindustry.Vars.content;
import static mindustry.Vars.invasionGracePeriod;
...
public class Universe {
	...
	public Schematic getLastLoadout() {
		if (lastLoadout == null)
			lastLoadout = state.rules.sector == null || state.rules.sector.planet.generator == null ? Loadouts.basicShard : state.rules.sector.planet.generator.defaultLoadout;
		return lastLoadout;
	}
