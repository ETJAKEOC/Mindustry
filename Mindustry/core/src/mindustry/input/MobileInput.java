...
import static mindustry.input.PlaceMode.rebuildSelect;
import static mindustry.input.PlaceMode.schematicSelect;
...
public class MobileInput extends InputHandler implements GestureListener {
	...
	public boolean pan(float x, float y, float deltaX, float deltaY) {
		if (Core.scene == null || Core.scene.hasDialog() || Core.settings.getBool("keyboard") || locked() || commandRect)
			return false;
