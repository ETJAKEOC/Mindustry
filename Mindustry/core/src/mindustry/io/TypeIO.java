...
import mindustry.entities.Units.UnitSyncContainer;
...
public class TypeIO{
    ...
    public static void writeObject(Writes write, Object object){
        switch(object){
            ...
            case Double d -> writeObject(write, d.doubleValue());
            case Building b -> {
            ...
            case Bullet b -> write.b((byte)0);
            case Seq<?> s -> write.b((byte)0);
            default -> throw new IllegalArgumentException("Unknown object type: " + object.getClass());
        }
    }
