...
public class GlobalVars {
	...
	private final ObjectMap<String, LVar> vars = new ObjectMap<>();
	private final Seq<VarEntry> varEntries = new Seq<>();
	private final ObjectSet<String> privilegedNames = new ObjectSet<>();
