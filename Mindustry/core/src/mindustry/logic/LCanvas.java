...
public class LCanvas extends Table {
	...
	public class DragLayout extends WidgetGroup {
		...
		boolean invalidated;
		private final Seq<JumpCurve> processedJumps = new Seq<>();
		private final IntMap<JumpCurve> reprBefore = new IntMap<>();
		private final IntMap<JumpCurve> reprAfter = new IntMap<>();
