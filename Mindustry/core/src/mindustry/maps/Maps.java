...
public class Maps {
	 ...
	 */
	private static final String[] defaultMapNames = {"maze", "fortress", "labyrinth", "islands", "tendrils", "caldera", "wasteland", "shattered", "fork", "triad", "mudFlats", "moltenLake", "archipelago", "debrisField", "domain", "veins", "glacier", "passage"};
	/**
	 * Maps tagged as PvP
	 */
	 ...
	 */
	private static final boolean useDefaultFolder = true;
	...
	public interface MapProvider {
		@Nullable
		Map next(Gamemode mode, @Nullable Map previous);
	}
}
