...
import static mindustry.Vars.multicastGroup;
...
public class ArcNetProvider implements NetProvider {
	...
	private final Ratekeeper clientUdpErrorRate = new Ratekeeper();
	...
	public static class PacketSerializer implements NetSerializer {
		...
		public Object read(ByteBuffer byteBuffer) {
			...
			if (id == -2) {
				...
				if (!packet.allow(net.server()))
					throw new RuntimeException("Invalid packet type for endpoint: " + packet.getClass());
