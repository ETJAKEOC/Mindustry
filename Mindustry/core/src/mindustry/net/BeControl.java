...
import static mindustry.Vars.bebuildDirectory;
import static mindustry.Vars.headless;
import static mindustry.Vars.javaPath;
...
public class BeControl {
	...
	private void download(String furl, Fi dest, Intc length, Floatc progressor, Boolp canceled, Runnable done, Cons<Throwable> error) {
		mainExecutor.submit(() -> {
			try {
				HttpURLConnection con = (HttpURLConnection) URI.create(furl).toURL().openConnection();
