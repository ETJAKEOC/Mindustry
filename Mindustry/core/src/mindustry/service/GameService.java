...
import static mindustry.service.Achievement.active10Polys;
import static mindustry.service.Achievement.allBlocksErekir;
import static mindustry.service.Achievement.allBlocksSerpulo;
import static mindustry.service.Achievement.allTransportOneMap;
import static mindustry.service.Achievement.becomeRouter;
import static mindustry.service.Achievement.blastFrozenUnit;
import static mindustry.service.Achievement.blastGenerator;
import static mindustry.service.Achievement.boostBuildingFloor;
import static mindustry.service.Achievement.boostUnit;
import static mindustry.service.Achievement.breakForceProjector;
import static mindustry.service.Achievement.buildGroundFactory;
import static mindustry.service.Achievement.buildMeltdownSpectre;
import static mindustry.service.Achievement.buildMendProjector;
import static mindustry.service.Achievement.buildOverdriveProjector;
import static mindustry.service.Achievement.buildT5;
import static mindustry.service.Achievement.buildWexWater;
import static mindustry.service.Achievement.captureAllSectors;
import static mindustry.service.Achievement.captureBackground;
import static mindustry.service.Achievement.captureNoBlocksBroken;
import static mindustry.service.Achievement.chainRouters;
import static mindustry.service.Achievement.circleConveyor;
import static mindustry.service.Achievement.completeErekir;
import static mindustry.service.Achievement.completeSerpulo;
import static mindustry.service.Achievement.controlTurret;
import static mindustry.service.Achievement.coolTurret;
import static mindustry.service.Achievement.defeatAttack5Waves;
import static mindustry.service.Achievement.destroyScatterFlare;
import static mindustry.service.Achievement.dieExclusion;
import static mindustry.service.Achievement.drop10kitems;
import static mindustry.service.Achievement.dropUnitsCoreZone;
import static mindustry.service.Achievement.drown;
import static mindustry.service.Achievement.enablePixelation;
import static mindustry.service.Achievement.fillCoreAllCampaign;
import static mindustry.service.Achievement.hoverUnitLiquid;
import static mindustry.service.Achievement.installMod;
import static mindustry.service.Achievement.issueAttackCommand;
import static mindustry.service.Achievement.joinCommunityServer;
import static mindustry.service.Achievement.killEclipseDuo;
import static mindustry.service.Achievement.killEnemyPhaseWall;
import static mindustry.service.Achievement.killMassDriver;
import static mindustry.service.Achievement.launchCoreSchematic;
import static mindustry.service.Achievement.launchItemPad;
import static mindustry.service.Achievement.negative10kPower;
import static mindustry.service.Achievement.neoplasiaExplosion;
import static mindustry.service.Achievement.neoplasmWater;
import static mindustry.service.Achievement.nucleusGroundZero;
import static mindustry.service.Achievement.obtainThorium;
import static mindustry.service.Achievement.obtainTitanium;
import static mindustry.service.Achievement.openConsole;
import static mindustry.service.Achievement.openWiki;
import static mindustry.service.Achievement.pickupT5;
import static mindustry.service.Achievement.positive100kPower;
import static mindustry.service.Achievement.powerupImpactReactor;
import static mindustry.service.Achievement.researchAll;
import static mindustry.service.Achievement.researchLogic;
import static mindustry.service.Achievement.researchRouter;
import static mindustry.service.Achievement.routerLanguage;
import static mindustry.service.Achievement.shockWetEnemy;
import static mindustry.service.Achievement.shockwaveTowerUse;
import static mindustry.service.Achievement.store1milPower;
import static mindustry.service.Achievement.suicideBomb;
import static mindustry.service.Achievement.survive10WavesNoBlocks;
import static mindustry.service.Achievement.useAnimdustryEmoji;
import static mindustry.service.Achievement.useFlameAmmo;
	...
	private void registerEvents() {
		...
		Events.on(BlockBuildEndEvent.class, e -> {
			if (campaign() && e.unit() != null && e.unit().team == state.rules.defaultTeam && !e.breaking()) {
				...
				if (e.tile().block() == Blocks.overdriveProjector)
					buildOverdriveProjector.complete();
