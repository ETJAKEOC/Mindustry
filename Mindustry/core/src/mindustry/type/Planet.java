...
import mindustry.game.CampaignStats;
...
public class Planet extends UnlockableContent {
	...
	public void loadIcon() {
		super.loadIcon();
		if (this.localizedName == null || this.localizedName.equals(this.name)) {
			String key = "planet." + name + ".name";
			if (Core.bundle != null && Core.bundle.has(key)) {
				...
				String altKey = "planet." + shortName + ".name";
