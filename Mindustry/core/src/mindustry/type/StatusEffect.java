...
public class StatusEffect extends UnlockableContent {
	...
	public void setStats() {
		...
		if (buildSpeedMultiplier != 1)
			stats.addMultModifier(Stat.buildSpeedMultiplier, buildSpeedMultiplier);
	...
	public void applied(Unit unit, float time, boolean extend) {
		if (!extend || applyExtend)
			applyEffect.at(unit.x, unit.y, 0, applyColor, parentizeApplyEffect ? unit : null);
	}
