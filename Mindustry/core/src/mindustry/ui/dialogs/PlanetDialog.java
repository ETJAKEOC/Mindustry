...
import static mindustry.Vars.accessibleIcons;
import static mindustry.Vars.content;
import static mindustry.Vars.control;
import static mindustry.Vars.defaultContentIcons;
import static mindustry.Vars.hadSerpuloRemaps;
...
import static mindustry.graphics.g3d.PlanetRenderer.PlanetInterfaceRenderer;
...
import mindustry.maps.SectorSubmissions;
import mindustry.type.Item;
import mindustry.type.ItemSeq;
import mindustry.type.ItemStack;
import mindustry.type.Planet;
import mindustry.type.Planet.PlanetData;
...
public class PlanetDialog extends BaseDialog implements PlanetInterfaceRenderer {
	...
	boolean canSelect(Sector sector) {
		...
		if (mode == planetLaunch && (sector.hasBase() || (sector.preset != null && sector.preset.addStartingItems)))
			return false;
	...
	boolean selectable(Planet planet) {
		...
		if (mode == planetLaunch)
			return launchSector != null && (launchCandidates.contains(planet) || (planet == launchSector.planet && planet.allowSelfSectorLaunch));
