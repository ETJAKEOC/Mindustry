...
public class Tiles implements Iterable<Tile> {
	...
	@Nullable
	long[] tmpFloorState, tmpBlockState;
	...
	public void setTmpFloorState(int pos, long value) {
		if (tmpFloorState == null || tmpFloorState.length != array.length)
			tmpFloorState = new long[array.length];
	...
	public void setTmpBlockState(int pos, long value) {
		if (tmpBlockState == null || tmpBlockState.length != array.length)
			tmpBlockState = new long[array.length];
