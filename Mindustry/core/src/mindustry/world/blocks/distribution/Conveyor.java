...
public class Conveyor extends Block implements Autotiler {
	...
	public void init() {
		...
		if (bridgeReplacement == null || !(bridgeReplacement instanceof ItemBridge || bridgeReplacement instanceof DuctBridge))
	...
	public void handlePlacementLine(Seq<BuildPlan> plans) {
		...
		if (bridgeReplacement instanceof ItemBridge bridge)
			Placement.calculateBridges(plans, bridge, hasJuntionReplacement, b -> b instanceof Conveyor);
	}
