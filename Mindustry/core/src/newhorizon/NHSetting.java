...
public class NHSetting {
    ...
    public static boolean getBool(String key) {
        return settings != null && settings.getBool(key);
    }

    public static boolean getBool(String key, boolean def) {
        return settings == null ? def : settings.getBool(key, def);
    }

    public static float getFloat(String key) {
        return settings == null ? 0f : settings.getFloat(key);
    }

    public static float getFloat(String key, float def) {
        return settings == null ? def : settings.getFloat(key, def);
    }
    ...
    public static abstract class SettingKey<T> {
        ...
        public void setDefault() {
            if (settings == null) return;
            if (!settings.has(key)) settings.put(key, def);
        }
