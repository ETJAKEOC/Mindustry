...
public class DefenseBlock {
    ...
    public static void load() {
        titaniumWall = new AdaptWall(NewHorizon.name("titanium-wall")) {{
            health = 750;
            armor = 2f;
            maxShareStep = 1;
        ...
        presstaniumWall = new AdaptWall(NewHorizon.name("presstanium-wall")) {{
            health = 1200;
            armor = 2f;
            maxShareStep = 1;
        ...
        refactoringMultiWall = new AdaptWall(NewHorizon.name("refactoring-multi-wall")) {{
            health = 1800;
            armor = 4f;
            maxShareStep = 2;
