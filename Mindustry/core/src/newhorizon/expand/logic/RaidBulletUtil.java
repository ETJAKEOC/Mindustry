...
public class RaidBulletUtil {
	...
	private static Color raidTint(BulletType type) {
		...
		if (type instanceof BasicBulletType basic && basic.backColor != null)
			return basic.backColor;
		return Color.white;
	}
	...
	public static String bundleCategory(BulletType type) {
		...
		if (is(type, NHBullets.shieldDestroyer, RaidBullets.raidBullet_7))
			return "bullet-shield-breaker";
	...
	public static String warningIcon(String category) {
		String icon = switch (category) {
			...
			case "bullet-railgun", "bullet-railgun-heavy", "bullet-shield-breaker",
			     "bullet-ancient" -> "event-rail-raid-t1";
			case "bullet-emp", "bullet-cluster", "bullet-area-ionization", "bullet-black-hole",
			     "bullet-missile",
