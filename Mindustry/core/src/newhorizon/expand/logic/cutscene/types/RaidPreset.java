...
public enum RaidPreset {
	PRESET_RAID_1(RaidBullets.defaultRaidBullet1, NHSounds.uiAlert1, "event-default-raid-t1", 15, 5, 1, 40),
	PRESET_RAID_2(RaidBullets.defaultRaidBullet2, NHSounds.uiAlert1, "event-default-raid-t2", 15, 5, 1, 40),
	PRESET_RAID_3(RaidBullets.defaultRaidBullet3, NHSounds.uiAlert1, "event-default-raid-t1", 15, 5, 1, 40),
