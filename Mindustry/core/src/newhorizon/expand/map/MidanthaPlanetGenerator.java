...
public class MidanthaPlanetGenerator extends PlanetGenerator {
	...
	public void genTile(Vec3 position, TileGen tile) {
		...
		if (Ridged.noise3d(seed + 124, position.x, position.y, position.z, 4, 12.92f) > -0.45)
	...
	private boolean isRidgedVeinCut(int x, int y, Block oreType) {
		if (oreType != Blocks.oreTungsten && oreType != EnvironmentBlock.oreSilicar && oreType != Blocks.oreThorium)
			return false;
