...
import static mindustry.Vars.steamPlayerName;
...
public class DesktopLauncher extends ClientLauncher {
	...
	void logSteamError(Throwable e) {
		...
		loadError = true;
		Log.err(e);
		try (OutputStream s = Files.newOutputStream(Path.of("steam-error-log-" + System.nanoTime() + ".txt"))) {
