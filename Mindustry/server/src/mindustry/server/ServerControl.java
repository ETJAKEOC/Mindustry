...
import static arc.util.ColorCodes.bold;
import static arc.util.ColorCodes.lightBlack;
import static arc.util.ColorCodes.lightRed;
import static arc.util.ColorCodes.reset;
import static arc.util.ColorCodes.values;
import static arc.util.Log.LogLevel;
import static arc.util.Log.addColors;
import static arc.util.Log.err;
import static arc.util.Log.format;
import static arc.util.Log.formatColors;
import static arc.util.Log.formatter;
